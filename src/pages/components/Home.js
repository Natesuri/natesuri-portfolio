  ...
  <section id="about" className='view active'>
          <div className='container'>
            <div className='double'>
              ...
              <div className='about'>
                <h2>Howdy! I'm <span className='emphasis-1'>Nate Suri</span>.</h2>
                <p>
                  I’m a <span className='emphasis-2'>storyteller</span> at heart with a mission to share the story of innovators and difference makers in my community and the world.
                  My experience in both filmmaking and programming gives me a unique perspective on how to create <span className='emphasis-3'>engaging and creative</span> web experiences.
                </p>
                <p>
