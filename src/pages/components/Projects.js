...
const Projects  = () => (
  <section id="projects" className='view'>
        ...
        <div className='samples'>
          <div className='project'>
            ...
            <div className='project-body'>
              ...
              <div className='tech'>
                <div className='first'>React</div>
                <div>Express</div>
                <div>MongoDB</div>
                <div>Mongoose</div>
                <div className='last'>Node</div>
              </div>
            </div>
          </div>
          <div className='project'>
            ...
            <div className='project-body'>
              ...
              <div className='tech'>
                <div className='first'>Express</div>
                <div>MongoDB</div>
                <div>JS</div>
                <div>HTML / CSS</div>
                <div>Handlebars</div>
          ...
          <div className='project'>
            ...
            <div className='project-body'>
              ...
              <div className='tech'>
                <div className='first'>Ruby on Rails</div>
                <div>PostgreSQL</div>
                <div>HTML / CSS</div>
                <div>JS</div>
                <div>Handlebars</div>
                <div className='last'>Bootstrap</div>
              </div>
            </div>
          </div>
          <div className='project'>
            ...
            <div className='project-body'>
              ...
              <div className='tech'>
                <div className='first'>JS</div>
                <div>HTML / CSS</div>
                <div>Bootstrap</div>
                <div className='last'>Sass</div>
              </div>
            </div>
          </div>
        </div>
